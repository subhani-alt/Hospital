...
export default function QuickAccessBar() {
  ...
  return (
    <section className="relative z-30 max-w-7xl mx-auto px-4 sm:px-8 -mt-10 mb-12">
      <div className="bg-white dark:bg-[#122824] rounded-3xl shadow-2xl border border-[#00695C]/15 p-4 sm:p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 backdrop-blur-xl">
          ...
          const content = (
            <div
              className={`p-4 rounded-2xl transition-all duration-300 flex items-center justify-between group cursor-pointer ${
                item.isEmergency
                  ? 'bg-red-50 dark:bg-red-950/30 hover:bg-red-100 border border-red-200 dark:border-red-800'
                  : 'bg-slate-50 dark:bg-white/5 hover:bg-[#E0F2F1] dark:hover:bg-white/10 border border-slate-100 dark:border-slate-800'
              }`}
            >
