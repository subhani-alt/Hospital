  ...
  const handleSendMessage = (e) => {
    ...
    setTimeout(() => {
      ...
      if (lower.includes('doctor') || lower.includes('specialist')) {
        botResponse = 'We have 250+ world-renowned clinicians across Gastroenterology, Cardiology, Oncology, Neurosciences, and Orthopedics. You can filter and book doctors via our "Find Doctors" tab.';
