    ...
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3 pointer-events-none">
      ...
      <div className="flex flex-col items-end gap-2.5 pointer-events-auto">
        ...
        <button
          ...
          className="group flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-4 py-2.5 rounded-full shadow-xl hover:shadow-emerald-900/30 hover:scale-105 transition-all duration-300 border border-white/20 text-xs font-semibold uppercase tracking-wider"
          title="AI Symptom Checker"
        >
          <Stethoscope className="w-4 h-4 text-emerald-200 animate-pulse" />
        ...
        <button
          ...
          className="group flex items-center gap-2 bg-white text-[#00695C] px-3.5 py-2.5 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 border border-[#00695C]/20 text-xs font-semibold"
          title="Virtual Assistant"
        >
          <Bot className="w-4 h-4 text-[#00695C]" />
        ...
        <button
          ...
          className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-4 py-2.5 rounded-full shadow-lg hover:shadow-red-700/40 hover:scale-105 transition-all duration-300 font-bold text-xs uppercase tracking-wider border border-white/30 animate-bounce sm:animate-none"
        >
