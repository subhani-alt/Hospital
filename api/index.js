...
const MOCK_PACKAGES = [
  ...
  { id: 'cardiac-vital-guard', name: 'Prestige Advanced Cardiac Protection Package', badge: 'Heart Special', category: 'Cardiology', price: 8999, original_price: 14000, tests_count: 45, recommended_for: 'Heart Risk, High BP, Family Cardiac History', highlights: ['CT Coronary Angiography', 'High Sensitivity CRP (hs-CRP)'], inclusions: ['Cardiology: CT Angio, Stress Test, 2D Echo', 'Consultation: Senior Interventional Cardiologist'] },
  { id: 'wellness-women-vital', name: 'Prestige Empress Women’s Wellness Shield', badge: 'Women Health', category: 'Women', price: 11499, original_price: 18000, tests_count: 78, recommended_for: 'Women of All Ages, Hormonal Health, Cervical & Breast Care', highlights: ['Digital Mammography / Breast USG', 'Liquid-based Pap Smear', 'DEXA Bone Density Scan'], inclusions: ['Gynecology: Pap Smear, Pelvic USG', 'Bone Health: DEXA Scan', 'Consultation: Senior Gynecologist'] },
  { id: 'gut-digestive-screen', name: 'Prestige Comprehensive Gut & Liver Shield', badge: 'GI Premier', category: 'Gastroenterology', price: 12999, original_price: 19500, tests_count: 52, recommended_for: 'Digestive Issues, Fatty Liver, Acidity, IBS Prevention', highlights: ['FibroScan (Liver Stiffness)', 'Diagnostic Upper GI Endoscopy'], inclusions: ['Gastro: Endoscopy, FibroScan, USG', 'Consultation: Senior Gastroenterologist'] },
  { id: 'senior-citizen-platinum', name: 'Prestige Senior Citizen Platinum Care Shield', badge: 'Senior Care', category: 'Geriatric Care', price: 7999, original_price: 13500, tests_count: 65, recommended_for: 'Seniors Aged 60+, Mobility, Vision & Chronic Wellness', highlights: ['DEXA Whole Body Bone Densitometry', 'Geriatric Functional Mobility Assessment', 'Diabetic Retinopathy & Glaucoma Screen'], inclusions: ['Geriatric Consultation', 'Arthritis Panel & Hemogram', 'Kidney & Electrolyte Profile'] },
  { id: 'diabetes-metabolic-guard', name: 'Prestige Advanced Diabetes & Metabolic Guard', badge: 'Diabetes Special', category: 'Endocrinology', price: 5999, original_price: 10000, tests_count: 42, recommended_for: 'Prediabetes, Type 1 & 2 Diabetes, Metabolic Syndrome', highlights: ['Continuous Glucose Monitoring (CGM) Review', 'Carotid Intima Thickness Scan', 'Diabetic Foot Neuropathy Screening'], inclusions: ['Endocrinology Consultation', 'HbA1c & Blood Glucose', 'Lipid Sub-fractions'] }
];
